...
//1111111111111111111
    for (DevModel tmpNode : MainDevListFragment.mDevices)
    {
      if (model.SN.equals(tmpNode.SN))
      {
        ...
        Log.e(tag, "NetConn reloadview get exist model:" + chooseModel.SN + ",isconnect is " + chooseModel.IsConnect() + ",mdevice size "
          + MainDevListFragment.mDevices.size() + ",handel is " + chooseModel.NetHandle);
        break;
      }
    }
